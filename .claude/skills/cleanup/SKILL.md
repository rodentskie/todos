...
7. Check if the .env.example has the same variables (not always the same value) as the .env. If something is missing, tell me.
...
- This is a monorepo setup, user must specify path of project to check. Example: `apps/app`
